<?php
	...
	if(isset($_POST['crop']) && isset($_POST['size']) && isset($_POST['soil_type']) && isset($_POST['irrigation_type']) && isset($_POST['farm_region']) && isset($_POST['farm_town']) && isset($_POST['block_id'])){
								...
								if(preg_match('/^[a-zA-Z_0-9]*$/',$farm_town)){
									if(!(strlen($farm_town)<2) && !(strlen($farm_town)>40)){
										if(preg_match('/^[0-9]*$/',$block_id)){
											...
											$farm->createFarmProfile($farm_name,$crop,$size,$soil_type,$irrigation_type,$farm_region,$farm_town,$block_id);
